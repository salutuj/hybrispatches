...
/**
 * This is the extension manager of the Hybrispatches extension.
 */
public class HybrispatchesManager extends GeneratedHybrispatchesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HybrispatchesManager.class.getName());
	 ...
	 */
	public static HybrispatchesManager getInstance()
	{
		return (HybrispatchesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HybrispatchesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HybrispatchesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HybrispatchesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HybrispatchesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HybrispatchesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
